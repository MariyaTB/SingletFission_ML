...
df_a = pd.read_csv('duplicate_data_clean/valid_unique_02_07_2025.csv')
df_b = pd.read_csv('duplicate_data_clean/valid_unique_smiles_02_07_2025(2).csv')
...
result.to_csv('duplicate_data_clean/valid_unique_smiles_02_07_2025(2).csv', index=False)