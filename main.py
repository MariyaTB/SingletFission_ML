...
def main():
    ...
    train_losses, val_losses = pretrain_clm(clm_model, combined_smiles, char_to_idx, device, epochs=15, batch_size=128, lr=0.001)
    logging.info("CLM pre-training complete")
    plot_learning_curves(train_losses, val_losses, 'Pre-training Learning Curves', 'pretraining_learning_curves_08_04_2025.png')
    ...
    plot_learning_curves(train_losses, val_losses, 'Fine-tuning Learning Curves', 'finetuning_learning_curves_08_04_2025.png')
    ...
    new_smiles = []
    for _ in tqdm(range(15000), desc="Generating SMILES"):
    ...
    pd.DataFrame(new_smiles, columns=['SMILES']).to_csv('data/generated_smiles_08_04_2025.csv', index=False)
    logging.info("Generated SMILES saved to 'data/generated_smiles_08_04_2025.csv'")
    ...
    pd.DataFrame(valid_new_smiles, columns=['SMILES']).to_csv('data/valid_unique_smiles_08_04_2025.csv', index=False)
    logging.info("Valid and unique SMILES saved to 'data/valid_unique_smiles_08_04_2025.csv'")
